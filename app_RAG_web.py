...
def process_input(urls, question):
    model_local = Ollama(base_url='http://103.220.68.101:11434',model="llama3.1")
    ...
    vectorstore = Chroma.from_documents(
        ...
        embedding=embeddings.OllamaEmbeddings(base_url='http://103.220.68.101:11434', model='nomic-embed-text'),
    )
...
st.title("Website Query with Ollama")
